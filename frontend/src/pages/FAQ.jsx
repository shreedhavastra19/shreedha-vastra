...
const faqs = [
  { q: 'What sizes do you offer?', a: 'We offer sizes from M to XXL across most of our collections. Each product page includes a size chart to help you find your perfect fit.' },
  ...
  { q: 'How do I track my order?', a: 'Once your order ships, you can track it from the "My Orders" section.' },
